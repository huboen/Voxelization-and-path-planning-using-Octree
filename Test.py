...
#     print(results)
    ...
    node_size =  np.array([1,2],dtype=np.float32)
    node_vertexes = node_vertex(nodes_center,node_size)
    ...
    collision_3d_triangle_box_cuda[blocks_per_grid,threads_per_block](d_triangles_vertex,d_triangles_normals,d_nodes_center,d_nodes_vertex,d_node_size,d_result)
